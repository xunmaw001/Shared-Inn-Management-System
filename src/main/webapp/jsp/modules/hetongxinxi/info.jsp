                        ...
                        <form id="addOrUpdateForm">
                            <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="htname" name="htname" class="form-control"
                                               v-model="ruleForm.htname" readonly>
                                    </div>
                                <div class="form-group col-md-6">
                                    <label>
                                        甲方名称
...
<script>
    ...
    function setDownloadBtn() {
        var proveFileUrl = "download('" + ruleForm.proveFile + "')";
        $("#proveFile").attr("onclick", proveFileUrl);
